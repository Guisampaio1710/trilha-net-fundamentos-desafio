        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                while (!valido)
                {
                    ...
                    if (int.TryParse(numero, out horas))
                    {
                        valido = true;
                    ...
                    {
                        Console.WriteLine("Hora inválida! Digite apenas números para as horas.");
        ...
        public void ListarVeiculos()
        {
            ...
            if (veiculos.Any())
            {
                ...
                for (int contador = 0; contador < veiculos.Count; contador++)
                {
                    ...
                    Console.WriteLine($"{contador + 1}. Placa:{veiculos[contador]}");


                }
                Console.WriteLine($"Quantidade de veículos no estacionamento: {veiculos.Count}");
            }
            else
            {
